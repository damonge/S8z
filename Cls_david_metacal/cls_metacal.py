...
printflush("Weights")
prefix_map1 = predir + 'derived_products/des_shear/maps_metacal_bin%d_ns%d' % (o.bin_number, o.nside)
...
if is_auto:
    ...
    prefix_map2 = predir + 'derived_products/des_shear/maps_metacal_bin%d_ns%d' % (o.bin_number_2, o.nside)
...
printflush("MCM")
fname_mcm = predir + 'derived_products/des_shear/cls_metacal_mcm_'
...
def get_fname_cl(irot):
    fname_cls = predir + 'derived_products/des_shear/cls_metacal_cls_'
